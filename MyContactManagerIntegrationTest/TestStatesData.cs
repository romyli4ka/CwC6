...
namespace MyContactManagerIntegrationTest
{
    public class TestStatesData
    {
        ...
        private const string IOWA_MISSSPELLING = "Iwoa";
        ...
        {
            _options = new DbContextOptionsBuilder<MyContactManagerDbContext>().UseInMemoryDatabase(databaseName: "MyContactManagerStatesTests").Options;
        }
        ...
        private void BuilderDefaults()
        {
            ...
            {
                var existingStates = Task.Run(() => context.State.ToListAsync()).Result;
